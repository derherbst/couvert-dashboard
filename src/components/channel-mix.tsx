...
const rows: ChannelRow[] = [
  { label: "Couvert app", count: 198, share: 0.45, isCouvert: true },
  { label: "Couvert web", count: 110, share: 0.25, isCouvert: true },
  { label: "Your website widget", count: 78, share: 0.18, isCouvert: false },
  { label: "Phone", count: 53, share: 0.12, isCouvert: false },
];
